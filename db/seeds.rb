...
garden_1 = Garden.create(name: 'My 1st garden', user_id: user_1.id, lat: -33.865269, lon: 151.1960453, length: 200, width: 100)
garden_2 = Garden.create(name: "Foo's garden", user_id: user_2.id, lat: -37.813008, lon: 144.945882, length: 5500, width: 700)
garden_3 = Garden.create(name: 'Garden Bar', user_id: user_3.id, lat: 51.515314, lon: -0.126344, length: 450, width: 150)
